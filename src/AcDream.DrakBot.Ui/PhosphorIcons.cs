...
/// <summary>
/// The Phosphor icons the windows use, as the characters that draw them.
/// The client merges the Phosphor glyph font (MIT) into the overlay's UI
/// font at the web font's code points, so an icon is just text: put one
/// of these in a label, or hand it to <see cref="DashboardDrawing.DrawIcon"/>
/// for a coloured one at a size of its own. The names are Phosphor's.
/// </summary>
