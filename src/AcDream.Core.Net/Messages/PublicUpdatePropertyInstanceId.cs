...
public static class PublicUpdatePropertyInstanceId
{
    public const uint Opcode = 0x02DAu;

    public readonly record struct Parsed(uint Guid, uint Property, uint Value);

    /// <summary>Parse a raw 0x02DA body. Returns null on opcode mismatch / truncation.</summary>
