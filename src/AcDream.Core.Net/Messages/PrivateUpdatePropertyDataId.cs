...
public static class PrivateUpdatePropertyDataId
{
    public const uint Opcode = 0x02D7u;

    public readonly record struct Parsed(uint Property, uint Value);

    /// <summary>Parse a raw 0x02D7 body. Returns null on opcode mismatch / truncation.</summary>
