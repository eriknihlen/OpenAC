...
public sealed class JournalPanelController : IRetainedPanelController
{
    ...
    public static JournalPanelController? Bind(ImportedLayout layout, Callbacks callbacks)
    {
        ...
        {
            Console.WriteLine(
                "[UI] JournalPanelController.Bind: root did not build as UiTabPanel "
        ...
        if (layout.FindElement(ContractsPageId) is { } contractsPage)
            ...
            Console.WriteLine("[UI] JournalPanelController: contracts page not found.");
        ...
        if (layout.FindElement(NotesPageId) is { } notesPage)
            ...
            Console.WriteLine("[UI] JournalPanelController: notes page not found.");
        ...
        {
            Console.WriteLine("[UI] JournalPanelController: page list not found.");
        }
