...
public sealed class KeyboardConfigController
{
        ...
        Func<uint, uint, UiDatFont?>? resolveTemplateFont = null)
    {
        ...
        {
            Console.WriteLine(
                $"[UI] KeyboardConfigController: window root 0x{WindowRootElementId:X8} "
        ...
        foreach ((uint pageContainerId, RetailActionClass cls) in Pages)
        {
            ...
            {
                Console.WriteLine(
                    $"[UI] KeyboardConfigController: page container 0x{pageContainerId:X8} "
            ...
            {
                Console.WriteLine(
                    $"[UI] KeyboardConfigController: ListBox 0x{ListBoxElementId:X8} not found "
        ...
        {
            Console.WriteLine(
                $"[UI] KeyboardConfigController: tab host 0x{TabHostElementId:X8} not found "
        ...
        UiTemplateListBox listBox, uint inputMapId, Func<uint, uint, string?> resolveString)
    {
        ...
        {
            Console.WriteLine(
                "[UI] KeyboardConfigController: header template did not build as UiText "
        ...
        {
            Console.WriteLine(
                $"[UI] KeyboardConfigController: header string '{headerKey}' did not resolve — "
        ...
        Bindings bindings)
    {
        ...
        {
            Console.WriteLine(
                "[UI] KeyboardConfigController: row template did not build for InputMap "
    ...
    private void BeginSlotCapture(RowView view, int slot, Bindings bindings)
    {
        ...
        if (bindings.OpenCaptureInstructions is { } openInstructions)
        {
            ...
            {
                Console.WriteLine(
                    "[UI] KeyboardConfigController: capture-instruction dialog "
