...
public sealed class Transition
{
    ...
    private void LogCellarCellSetSummary(
        PhysicsEngine engine,
        ...
        float sphereRadius)
    {
        ...
        LogCellarCellBspProbe(engine, 0xA9B40146u, footCenter, sphereRadius);
    }

    private void LogCellarCellBspProbe(
        PhysicsEngine engine,
        uint cellId,
        Vector3 footCenter,
        float sphereRadius)
    {
        ...
        if (cell.Resolved.Count > 0)
            LogNearestWalkableCandidate("cellar-ascent-target", cellId, local, sphereRadius, cell.Resolved);
    }
        ...
        Dictionary<ushort, ResolvedPolygon> resolved)
    {
        ...
        LogCellarWalkableCandidateDetail(
            site, cellId, nearestId, nearest, localCenter, sphereRadius, stepSearch);
    }

    private void LogCellarWalkableCandidateDetail(
        string site,
        uint cellId,
        ushort polyId,
