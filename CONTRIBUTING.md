...
The built-in bot, DrakBot (`src/AcDream.DrakBot`), is held to a stricter rule: nothing in it
...
comments that cite their internals. `docs/drakbot.md` spells this out.
