...
<!-- Replace with a screenshot of the client in Holtburg: assets/readme/screenshot.png -->
...
protocol, and exposes a plugin API the original never had. The engine's
internal codename is *acdream*, which is why the assemblies, environment
variables, and prepared-package file still carry that name.
...
17,000 tests in CI), it survives an independent AI review pass, and it behaves
