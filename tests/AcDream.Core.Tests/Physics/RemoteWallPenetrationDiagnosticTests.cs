...
public class RemoteWallPenetrationDiagnosticTests
{
    private readonly ITestOutputHelper _out;
    public RemoteWallPenetrationDiagnosticTests(ITestOutputHelper output) => _out = output;
    ...
    public void SingleLargeTickJumpThroughObstacle_IsStillBlockedAtSurface()
    {
        ...
        Assert.True(
            ...
            + "single-tick deltas) is CONFIRMED as a contributing wall-penetration mechanism.");
    }
