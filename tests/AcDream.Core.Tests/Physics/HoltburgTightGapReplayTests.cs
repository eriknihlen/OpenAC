...
public sealed class HoltburgTightGapReplayTests
{
    private readonly ITestOutputHelper _output;

    public HoltburgTightGapReplayTests(ITestOutputHelper output)
        => _output = output;
        ...
        bool includeBlockingPost = true)
    {
        ...
        Assert.True(File.Exists(dumpPath), $"Missing tight-gap fixture: {dumpPath}");
