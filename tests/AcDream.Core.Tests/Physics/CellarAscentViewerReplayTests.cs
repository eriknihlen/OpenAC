...
public class CellarAscentViewerReplayTests
{
    private readonly ITestOutputHelper _out;
    public CellarAscentViewerReplayTests(ITestOutputHelper output) => _out = output;
    ...
    public void CellarAscent_ViewerStaysInterior_WhileEyeBelowGrade()
    {
        ...
        Assert.True(failures.Count == 0,
            ...
            "is below grade — the exposed grass window (see output for the branch attribution)");
    }
}
