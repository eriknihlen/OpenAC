...
{
    public static ElementInfo LoadConnectionInfos() => LoadInfos("connection_21000000.json");
    ...
    public static ImportedLayout LoadConnectionScreen()
        => LayoutImporter.Build(LoadInfos("connection_21000000.json"), _ => (0u, 0, 0), null,
            stringResolve: value => value.StringId switch
            {
                0x045DA533u => "Connect progress",
                0x0032A2F7u => "Connecting...",
                0x0B032A54u => "Connected!",
                0x0712A673u => "Update progress",
                _ => null,
            });
